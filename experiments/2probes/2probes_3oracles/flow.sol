...
contract CertificationModel{
    ...
    uint public constant SIZE = 2; //size of the evidence collection model
    ...
    constructor(string memory _non_functional_property, string memory _target_of_certification, address _apiConsumerAddr, address _preCoordinatorAddr, bytes32 _jobIdHeartBleed, bytes32 _jobIdObservatory){
