...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestHeartbleed(address _oracleAddr, bytes32 jobId) public returns (bytes32 requestId) {
        ...
        req.add("get", "https://marcopedrinazzi.github.io/tesi5-frontend/evidence/heartbleed-vuln.json");
        req.add("path","status");
        req.addInt("times", 1);
    ...
    function requestObservatory(address _oracleAddr, bytes32 jobId) public returns (bytes32 requestId) {
        ...
        req.add("get", "https://marcopedrinazzi.github.io/tesi5-frontend/evidence/observatory-vuln.json");
        req.add("path","status");
        req.addInt("times", 1);
        return sendChainlinkRequestTo(_oracleAddr, req, FEE);
    }
    ...
    function requestSslyze(address _oracleAddr, bytes32 jobId) public returns (bytes32 requestId) {
        ...
        req.add("get", "https://marcopedrinazzi.github.io/tesi5-frontend/evidence/sslyze-vuln.json");
        req.add("path","status");
        req.addInt("times", 1);
        return sendChainlinkRequestTo(_oracleAddr, req, FEE);
    }
    ...
    function requestWebvulnscan(address _oracleAddr, bytes32 jobId) public returns (bytes32 requestId) {
        ...
        req.add("get", "https://marcopedrinazzi.github.io/tesi5-frontend/evidence/web-vuln-scan-vuln.json");
        req.add("path","status");
        req.addInt("times", 1);
        return sendChainlinkRequestTo(_oracleAddr, req, FEE);
    }
    ...
    function requestLightweightvulnscan(address _oracleAddr, bytes32 jobId) public returns (bytes32 requestId) {
        ...
        req.add("get", "https://marcopedrinazzi.github.io/tesi5-frontend/evidence/lightweight-vuln-scan-vuln.json");
        req.add("path","status");
        req.addInt("times", 1);
        return sendChainlinkRequestTo(_oracleAddr, req, FEE);
    }
